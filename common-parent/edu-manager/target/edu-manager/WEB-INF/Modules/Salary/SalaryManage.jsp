...
<body>
    ...
    <div class="main">
        <div class="sidbar" id="sidbar">
            <div class="sub_nav">
                <h2><p class="systemIcon">薪資管理</p></h2>
                    ...
                    <ul id="show_iframe" class="switch_nav">
						<li class="nav_current">
							<a href="#" class="subNavigation" id="A001010"
							   ...
							   data-url="${pageContext.request.contextPath}/salary/info.do">用户薪資信息</a>
						</li>
						<li class="nav_current">
							<a href="#" class="subNavigation" id="A001011"
							   data-name="common_iframe" onclick="Common.switchNavigation(this);"
							   data-url="${pageContext.request.contextPath}/salary/otherInfo.do">其它信息</a>
						</li>
		...
		<div id="common_iframe" class="maincontent">
			<iframe class="common_iframe" id="A001010_iframe" frameborder="0" border="0" src="${pageContext.request.contextPath}/salary/info.do"></iframe>
		</div>
    </div>
    </form>
</body>
